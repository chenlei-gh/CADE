...
- **Generated Work Products**: CADE asserts no copyright, intellectual property claim, or license propagation over the CAA code, scaffolding, or component artifacts generated by or derived through its execution. All bespoke CAA source files and design artifacts generated for your project are your exclusive work product.
...
- **生成工件与业务代码所有权**：CADE 不对使用本工具生成、派生或辅助构建的 CAA 业务源码、工程脚手架及定制构件主张任何版权所有权或开源协议传染性。用户对其输入提示、定制构件与专有业务代码享有完整自主权。
