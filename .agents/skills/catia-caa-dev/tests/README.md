...
| `test_specification.py` | L2-5 Specification |
| `test_diagnostics.py` | L2-6 Diagnostics |
| `test_fixplan_executor.py` | L2-7 FixPlan Executor |
| `test_refactor.py` | L2-8 Refactor |
| `test_production_regressions.py` | L2-9 Production Regressions |
...
| `test_ui_generator_clarifier.py` | 磁盘上存在，当前未进 `SUITES` |
