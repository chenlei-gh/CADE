...
try:
    ...
    # cmd is ["cmd", "/c", <path to generated .bat>] — the actual chain lives
    # inside the temp .bat file, summarized by `display`, not in argv itself.
    check("2.2 mkinit in command", "mkinit" in display.lower())
